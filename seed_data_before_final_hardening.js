(function initMojaZahradaSeedData(globalScope) {
  ...
  const constants = globalScope.MojaZahradaConstants || {};
  const NODE_TYPES = constants.NODE_TYPES || { PARENT: "parent", KIND: "kind" };
  const ROOT_CATEGORY = constants.ROOT_CATEGORY || {
    GARDEN: "root-zahrada",
    NATURE: "root-priroda",
    HARVEST: "root-uroda",
    OTHER: "root-ine"
  };
  const CATEGORY_IDS = constants.CATEGORY_IDS || {
  ...
  const FALLBACK_CATEGORY_ID = constants.FALLBACK_CATEGORY_ID || CATEGORY_IDS.FALLBACK;
