  ...
  if (typeof registry.createCategoriesModule !== "function") {
    registry.createCategoriesModule = function createCategoriesModule(deps = {}) {
      ...
      const {
        ...
        getIsFocusedView: rawGetIsFocusedView,
        ALWAYS_PROTECTED_CATEGORY_IDS: rawAlwaysProtectedCategoryIds,
        FALLBACK_CATEGORY_ID: rawFallbackCategoryId,
        ROOT_CATEGORY_IDS: rawRootCategoryIds,
        STRUCTURE_CATEGORY_DEFAULTS: rawStructureCategoryDefaults,
        STRUCTURE_CATEGORIES: rawStructureCategories,
        isDetailEntry: rawIsDetailEntry,
        logModuleError,
        CARD_TYPES: rawCardTypes,
        ROOT_CATEGORY: rawRootCategory,
        CATEGORY_IDS: rawCategoryIds,
        NODE_TYPES: rawNodeTypes
      } = deps;
      ...
      function requireMap(name, value) {
      ...
      const CARD_TYPES = requireValue("CARD_TYPES", rawCardTypes ?? constants.CARD_TYPES);
      const ROOT_CATEGORY = requireValue("ROOT_CATEGORY", rawRootCategory ?? constants.ROOT_CATEGORY);
      const CATEGORY_IDS = requireValue("CATEGORY_IDS", rawCategoryIds ?? constants.CATEGORY_IDS);
      const NODE_TYPES = requireValue("NODE_TYPES", rawNodeTypes ?? constants.NODE_TYPES);
      ...
      const getIsFocusedView = requireFunction("getIsFocusedView", rawGetIsFocusedView);
      const ALWAYS_PROTECTED_CATEGORY_IDS = requireArray("ALWAYS_PROTECTED_CATEGORY_IDS", rawAlwaysProtectedCategoryIds);
      const STRUCTURE_CATEGORY_DEFAULTS = requireMap("STRUCTURE_CATEGORY_DEFAULTS", rawStructureCategoryDefaults);
      const STRUCTURE_CATEGORIES = requireArray("STRUCTURE_CATEGORIES", rawStructureCategories);
