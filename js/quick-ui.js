  ...
  if (typeof registry.createQuickUiModule !== "function") {
    registry.createQuickUiModule = function createQuickUiModule(deps = {}) {
      ...
      const {
        ...
        JOURNAL_ENTRY_TYPE_OPTIONS: rawJournalEntryTypeOptions,
        CARD_TYPE_OPTIONS: rawCardTypeOptions,
        QUICK_ADD_ACTION_IDS: rawQuickAddActionIds,
        CARD_TYPES: rawCardTypes,
        isCategoryCompatibleWithCardType: rawIsCategoryCompatibleWithCardType,
        logModuleError
      } = deps;
      ...
      const JOURNAL_ENTRY_TYPE_OPTIONS = requireArray("JOURNAL_ENTRY_TYPE_OPTIONS", rawJournalEntryTypeOptions);
      const CARD_TYPE_OPTIONS = requireArray("CARD_TYPE_OPTIONS", rawCardTypeOptions);
      const QUICK_ADD_ACTION_IDS = requireArray("QUICK_ADD_ACTION_IDS", rawQuickAddActionIds);
      const CARD_TYPES = requireValue("CARD_TYPES", rawCardTypes ?? constants.CARD_TYPES);
      const isCategoryCompatibleWithCardType = requireFunction("isCategoryCompatibleWithCardType", rawIsCategoryCompatibleWithCardType);
