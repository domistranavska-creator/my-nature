(function initMojaZahradaUiModule(globalScope) {
  ...
  if (typeof registry.createUiModule !== "function") {
    registry.createUiModule = function createUiModule(deps = {}) {
      ...
      const createUiHelpersModule = typeof registry.createUiHelpersModule === "function"
        ? registry.createUiHelpersModule
        : null;
      ...
      let progressCard = (title, meta, value, tone, actionsHtml = "") => `
      ...
      `;
      let miniItem = (title, meta, varietyId = "", options = {}) => {
      ...
      if (createUiHelpersModule) {
        uiHelpers = createUiHelpersModule({
          escapeHtml,
          escapeAttribute,
          logModuleError
        });
        progressCard = uiHelpers.progressCard;
        miniItem = uiHelpers.miniItem;
      } else {
        reportModuleError(new Error("[MojaZahrada] Missing optional dependency: createUiHelpersModule"));
      }
